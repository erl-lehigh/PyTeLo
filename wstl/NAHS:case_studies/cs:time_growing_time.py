...
if __name__ == '__main__':
    ...
    #                     (y>=2)) && G[1,{}] ((z<= 9) && (z>=2)) && \
    #                     G[1,{}] ((u<= 9) && (u>=2)) && G[1,{}] ((v>= -9) && (v<=-2))\
    #                     && G[1,{}] ((w>= -9) && (w>=2))"
    # wstl_specification = ("&&^weight1 (G[0,{}]^weight1(&&^weight1((x<= 9), (x>=3))),\
    #                                   G[0,{}]^weight1(&&^weight1((y<= 9), (y>=3))),\
    #                                   G[0,{}]^weight1(&&^weight1((z<= 9), (z>=3))),\
    #                                   G[0,{}]^weight1(&&^weight1((u<= 9), (u>=3))),\
    #                                   G[0,{}]^weight1(&&^weight1((v<= 9), (v>=3))),\
    #                                   G[0,{}]^weight1(&&^weight1((w<= 9), (w>=3))))")
    n_ = 400
    randomseeds = 1
    ...
    for i in range(randomseeds):
        ...
        for n in range(2,n_):
            ...
            stl_specification = ("G[1,{}] ((x<= 9) && (x>=3)) && G[1,{}] ((y<= 9) && \
                        (y>=2)) && G[1,{}] ((z<= 9) && (z>=3)) && \
                        G[1,{}] ((u<= 9) && (u>=3)) && G[1,{}] ((v<= 9) && (v>=3))\
                        && G[1,{}] ((w<= 9) && (w>=3))").format(ub,ub,ub,ub,ub,ub)
            ...
            wstl_specification = ("&&^weight1 (G[0,{}]^weight1(&&^weight1((x<= 9), (x>=3))),\
                                      ...
                                      G[0,{}]^weight1(&&^weight1((u<= 9), (u>=3))),\
                                      G[0,{}]^weight1(&&^weight1((v<= 9), (v>=3))),\
                                      G[0,{}]^weight1(&&^weight1((w<= 9), (w>=3))))").format(ub,ub,ub,ub,ub,ub)
            stl_start = time.time()
